...
**Asana** built what they call AI Teammates, collaborative agents that take on assigned tasks and draft deliverables directly inside Asana projects, working alongside human team members. Their engineering leadership noted that Managed Agents let them ship advanced agentic features dramatically faster than their previous development pace. The Asana case is notable because it shows agents embedded in an existing workflow tool rather than as a standalone product. These agents look like collaborators rather than separate tools.
