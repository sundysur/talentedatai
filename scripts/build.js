...
/* DARK MODE TOGGLE — sliding pill */
    ...
    .cookie-banner__decline{font-family:var(--font-body);font-size:14px;padding:8px 20px;border-radius:var(--radius, 8px);border:1.5px solid rgba(255,255,255,0.3);background:transparent;color:#e0e0f0;cursor:pointer;transition:border-color 200ms ease}
    .cookie-banner__decline:hover{border-color:#fff}
